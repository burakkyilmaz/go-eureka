...
function getEmbeddings() {
    ...
    try {
        ...
        const modelName = process.env.SENTENCE_TRANSFORMERS_MODEL || 'Xenova/all-MiniLM-L6-v2';
 ...
 */
export async function initializeVectorStore(markdownPath, chunkSize = 1000, chunkOverlap = 200) {
    try {
 ...
 * @param chunkOverlap Number of characters to overlap between chunks
 */
export async function indexMarkdown(markdownPath, chunkSize = 1000, chunkOverlap = 200) {
    try {
 ...
 */
export async function indexAllMarkdownFiles(dirPath, chunkSize = 1000, chunkOverlap = 200) {
    try {
