...
export default function answerAppium(server) {
    server.addTool({
                ...
                try {
                    ...
                    return {
                        content: [
                            {
                                type: 'text',
                                text: `Error querying Appium documentation: ${retryError.message}. Please ensure the documentation is indexed first.`,
                            },
                        ],
                        isError: true,
                    };
