...
export class ADBManager {
     ...
     */
    async _createADBInstance(options = {}) {
 ...
 * @returns Promise<ADB> The ADB instance
 */
export async function getADBInstance(options = {}) {
 ...
 * @returns ADB instance or null if not initialized
 */
export function getExistingADBInstance() {
    return adbManager.getADBInstance();
}
//# sourceMappingURL=adb-manager.js.map